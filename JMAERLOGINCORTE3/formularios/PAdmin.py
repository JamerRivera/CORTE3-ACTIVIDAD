...
class PAdmin(tk.Tk):
    def __init__(self, name="", username="", email=""):
        ...
        self.imgfacebook = utl.leer_imagen(r"imagenes/face.png",(48,48))
        self.imglinkedin = utl.leer_imagen(r"imagenes/linkedin.png", (48,48))
        self.imgwebsite = utl.leer_imagen(r"imagenes/website.png", (48,48))
        self.imglogout = utl.leer_imagen(r"imagenes/logout.png", (48,48))
